...
namespace dci::module::ppn::connectivity::reest
{
    namespace
    {
            ...
            : public dci::host::module::Entry
        {
            ...
            {
                if(auto s = tryCreateService<Reest>(ilid)) return cmt::readyFuture(s);
...
extern "C"
{
    DCI_INTEGRATION_APIDECL_EXPORT dci::host::module::Entry* dciModuleEntry = &dci::module::ppn::connectivity::reest::entry_;
}
